...
export default function DevPanel({
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v) onClose() }}>
      <DialogContent className="sm:max-w-sm max-h-[80vh] flex flex-col overflow-hidden">
        {/* ─── Header ─── */}
        <DialogHeader className="px-4 pt-4 pb-0 gap-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <DialogTitle className="text-sm tracking-tight">Game Monitor</DialogTitle>
                <DialogDescription className="flex items-center gap-1.5 text-[9px]">
